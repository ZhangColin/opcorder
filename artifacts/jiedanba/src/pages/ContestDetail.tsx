...
/* ─── Smart attachment (handles .md inline preview) ─── */
    ...
    return (
      <>
        ...
        <button onClick={() => setPreview(true)}
          className="flex items-center gap-1.5 text-xs text-blue-600 hover:underline bg-white rounded-lg px-3 py-2 border border-slate-200 w-full text-left">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1.5">
                {q.attachments.map((a, i) => (
                  <SmartAttachmentLink key={i} name={a.name} url={a.url} />
                ))}
              </div>
            </div>
          )}
