...
export default function AdminV2TicketBDetail({ inlineId }: { inlineId?: number } = {}) {
  ...
  if (loading) return <AdminV2Layout backHref="/admin/v2/tickets-b" backLabel="工单"><div className="flex justify-center py-20"><Loader2 size={28} className="animate-spin text-primary" /></div></AdminV2Layout>;
  if (!ticket) return <AdminV2Layout backHref="/admin/v2/tickets-b" backLabel="工单"><div className="text-center py-16 text-slate-400">工单不存在</div></AdminV2Layout>;
