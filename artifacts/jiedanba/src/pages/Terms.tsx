...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">1. 总则</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">2. 平台简介与服务描述</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">3. 用户资格与账号管理</h2>
  <p class="mb-2">
...
<section id="community">
  <h2 class="text-base font-bold text-slate-900 mb-3">4. 用户行为规范与社区准则</h2>
  <p class="mb-2">您在使用本平台过程中，不得从事以下行为：</p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">5. 交易规则与资金结算</h2>
  <p class="mb-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">6. 知识产权</h2>
  <p>
...
<section id="regulatory">
  <h2 class="text-base font-bold text-slate-900 mb-3">7. 监管披露</h2>
  <p class="mb-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">8. 免责声明</h2>
  <p class="mb-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">9. 条款修改</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">10. 适用法律与争议解决</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">11. 联系方式</h2>
  <p>
...
export default function Terms() {
  ...
  const updatedDate = settings?.legal_terms_updated || STATIC_UPDATED;
  const dynamicContent = settings?.legal_terms_content?.trim() || "";
