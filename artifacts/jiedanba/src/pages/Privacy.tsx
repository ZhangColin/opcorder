...
const ALLOWED_TAGS = ["section", "h2", "h3", "h4", "p", "ul", "ol", "li", "strong", "em", "a", "br", "span"];
const ALLOWED_ATTR = ["class", "id", "href", "target", "rel"];

function sanitizeLegal(html: string): string {
  return DOMPurify.sanitize(html, { ALLOWED_TAGS, ALLOWED_ATTR });
}

const STATIC_UPDATED = "2026 年 1 月 1 日";

const STATIC_CONTENT = `
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">1. 引言</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">2. 我们收集的信息</h2>
  <p class="mb-2">在您使用本平台的过程中，我们可能收集以下类型的信息：</p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">3. 信息使用目的</h2>
  <p class="mb-2">我们将收集的信息用于以下目的：</p>
  <ul class="list-disc list-inside space-y-1 pl-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">4. 信息共享与披露</h2>
  <p class="mb-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">5. 信息存储与安全</h2>
  <p class="mb-2">
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">6. Cookie 及类似技术</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">7. 您的权利</h2>
  <p class="mb-2">依据《个人信息保护法》等相关法律法规，您享有以下权利：</p>
  <ul class="list-disc list-inside space-y-1 pl-2">
    <li>查阅、复制您的个人信息；</li>
  ...
  <p class="mt-2">如需行使上述权利，请通过第 9 条联系方式与我们联系。</p>
</section>

<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">8. 未成年人保护</h2>
  <p>
...
<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">9. 联系方式</h2>
  <p>
  ...
  <p class="mt-2">我们将在收到请求后 15 个工作日内予以回复。</p>
</section>

<section>
  <h2 class="text-base font-bold text-slate-900 mb-3">10. 政策更新</h2>
  <p>
...
export default function Privacy() {
  ...
  const updatedDate = settings?.legal_privacy_updated || STATIC_UPDATED;
  const dynamicContent = settings?.legal_privacy_content?.trim() || "";
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-slate-400 mb-10">最后更新：{updatedDate}</p>

        <div
          className="space-y-10 text-sm text-slate-700 leading-relaxed"
          dangerouslySetInnerHTML={{ __html: sanitizeLegal(dynamicContent || STATIC_CONTENT) }}
        />
      </main>
