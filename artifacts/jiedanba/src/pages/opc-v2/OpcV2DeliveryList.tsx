                    ...
                    <div className="flex items-end gap-4">
                      <div className="flex gap-4 flex-1 min-w-0 flex-wrap">
                        ...
                        {item.status === "approved" && item.approvedAt && (
                          <div>
                            <p className="text-[10px] text-slate-400 uppercase tracking-wider">通过时间</p>
                            <p className="text-sm text-green-600">{new Date(item.approvedAt).toLocaleDateString("zh-CN")}</p>
                          </div>
                        )}
                      </div>
