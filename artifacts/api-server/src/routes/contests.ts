  ...
  try {
    ...
    const rows = await db
      .select({
        ...
        registrationEndAt: contestsTable.registrationEndAt,
        publicAt: contestsTable.publicAt,
        benefitAt: contestsTable.benefitAt,
        deadlineAt: contestsTable.deadlineAt,
        announcementTitle: contestsTable.announcementTitle,
        announcementDetails: contestsTable.announcementDetails,
